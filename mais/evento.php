...
body, td, marquee, div, span, a, font, input, select, textarea {
...
<?
$action = 'evento_atualizar.php';
$btn_submit = 'Atualizar';
$btn_style = '';
if ($id_evento == '') {
	$action = 'evento_adicionar.php';
	$btn_submit = 'Adicionar';
	$btn_style = 'display: none;';
}
?>
<FORM ACTION="<?=$action;?>" ID="frm_produto" METHOD="POST" NAME="frm_produto" ENCTYPE="MULTIPART/FORM-DATA" onSubmit="return analisa_form(this);">
...
<TABLE ALIGN="CENTER">
	<TR>
		<TD COLSPAN="2"><A HREF="eventos.php">Eventos</A> - Evento <?=@mysql_result($evento,0,'ID');?></TD>
	</TR>
	<TR>
	...
	<TR>
		<TD CLASS="td_login">Local:</TD>
		<TD><INPUT TYPE="TEXT" NAME="txt_local" ID="txt_local" STYLE="width: 100%;" VALUE="<?=@mysql_result($evento,0,'LOCAL');?>"></TD>
	</TR>
	<TR>
		<TD CLASS="td_login">Quando:</TD>
		<TD><INPUT TYPE="TEXT" NAME="txt_dia" ID="txt_dia" VALUE="<?=@mysql_result($evento,0,'DIA_EVENTO');?>" SIZE="3" MAXLENGTH="2" onKeyPress="return filtra_numeros(this);" STYLE="text-align: center;"> / 
			<INPUT TYPE="TEXT" NAME="txt_mes" ID="txt_mes" VALUE="<?=@mysql_result($evento,0,'MES_EVENTO');?>" SIZE="3" MAXLENGTH="2" onKeyPress="return filtra_numeros(this);" STYLE="text-align: center;"> / 
			<INPUT TYPE="TEXT" NAME="txt_ano" ID="txt_ano" VALUE="<?=@mysql_result($evento,0,'ANO_EVENTO');?>" SIZE="5" MAXLENGTH="4" onKeyPress="return filtra_numeros(this);" STYLE="text-align: center;"></TD>
	</TR>
	<TR>
		<TD CLASS="td_login">Horário:</TD>
		<TD><INPUT TYPE="TEXT" NAME="txt_hora" ID="txt_hora" VALUE="<?=@mysql_result($evento,0,'HORA_EVENTO');?>" SIZE="3" MAXLENGTH="2" onKeyPress="return filtra_numeros(this);" STYLE="text-align: center;"> : 
			<INPUT TYPE="TEXT" NAME="txt_minuto" ID="txt_minuto" VALUE="<?=@mysql_result($evento,0,'MINUTO_EVENTO');?>" SIZE="3" MAXLENGTH="2" onKeyPress="return filtra_numeros(this);" STYLE="text-align: center;"> : 
			<INPUT TYPE="TEXT" NAME="txt_segundo" ID="txt_segundo" VALUE="<?=@mysql_result($evento,0,'SEGUNDO_EVENTO');?>" SIZE="3" MAXLENGTH="2" onKeyPress="return filtra_numeros(this);" STYLE="text-align: center;"></TD>
	</TR>
	<TR>
...
?>
			<IMG STYLE="border: 0px; width: <?=$tam_img_tmp[0];?>px; height: <?=$tam_img_tmp[1];?>px;" NAME="img_foto" ID="img_foto" SRC="<?=$link_img;?>"><BR>
			<INPUT TYPE="FILE" NAME="file_img" ID="file_img" STYLE="width: 100%;"><BR>
			<INPUT TYPE="BUTTON" VALUE="Adicionar imagem" onClick="adicionar_imagem();">
		</TD>
	</TR>
	<TR>
...
?>
	...
	<TR>
		<TD STYLE="text-align: center;" COLSPAN="7"><INPUT TYPE="SUBMIT" VALUE="<?=$btn_submit;?>"> <INPUT TYPE="RESET" VALUE="Cancelar"> <INPUT TYPE="BUTTON" VALUE="Excluir" onClick="abrir_janela('excluir_evento.php?id_evento=<?=$id_produto;?>&id_categoria=<?=$id_categoria;?>','_self');" STYLE="<?=$btn_style;?>"></TD>
	<TR>
</TABLE>
</FORM>
